...
namespace BotChatV4Demo
{
    ...
    {
        #region create card demo
 
        //create apdaptive card
        ...
        //create product thumbnailCard card
        public static ThumbnailCard CreateProductThumbnailCardMenu(Product food)
        {
            var thumbnailCard = new ThumbnailCard
            {
                Title = food.Name,
                Subtitle = "Get it now!",
                Text = "As your baby gets older, she starts to need solid food so she can get enough iron and other essential nutrients for growth and development.",
                Images = new List<CardImage> { new CardImage(food.Image) },
                Buttons = new List<CardAction> { new CardAction(ActionTypes.ImBack, "Order", value: food.Code) },
            };

            return thumbnailCard;
        }

        //create menu HeroCard card
        public static HeroCard CreateMainMenuHeroCardMenu(Menu menu)
        {
            var heroCard = new HeroCard
            {
                Title = menu.Name,
                Text = menu.Description,
                Images = new List<CardImage> { new CardImage(menu.Image) },
                Buttons = new List<CardAction> { new CardAction(ActionTypes.ImBack, menu.Action, value: menu.Code) },
            };
        ...
        public static ReceiptCard CreateOrder(Order order)
        {
            ...
            {
                Title = "YOUR ORDER",
                Facts = new List<Fact> { new Fact("Name", order.Name), new Fact("Phone Number", order.Phone) },
                Items = productList,
                Tax = "$0",
                Total = "$" + total,
            };
